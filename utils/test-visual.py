...
def visualize(wsi_folder: Path, 
    ...
    for whole_slide in whole_slides:
        # Read in the image.
        print(whole_slide)
        whole_slide_numpy = tiff.imread(whole_slide)[..., [0, 1, 2]]
...
visualize(Path('wsi-folder'), Path('output_folder'), Path('output_folder/visualizations'), [0,1,2], 3, ['red','green', 'blue'], 1024)